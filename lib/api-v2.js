...
export const authSignUp = async (username, usernameVerify, password) =>
  apiFetch(`/v2/auth/signup/`, {
    method: "POST",
    body: JSON.stringify({
      username,
...
export const postForUser = async (path, token, data) =>
  apiFetch(path, {
    method: "POST",
